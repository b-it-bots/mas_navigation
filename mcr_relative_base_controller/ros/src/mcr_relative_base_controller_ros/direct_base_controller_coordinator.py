...
class DirectBaseControllerCoordinator(object):
    ...
    def __init__(self):
        ...
        self.pose_converter_event_in = rospy.Publisher(
            '~pose_converter_event_in', std_msgs.msg.String, latch=True
        )
        self.pose_error_calculator_event_in = rospy.Publisher(
            '~pose_error_calculator_event_in', std_msgs.msg.String, latch=True
        )
        self.pose_error_monitor_event_in = rospy.Publisher(
            '~pose_error_monitor_event_in', std_msgs.msg.String, latch=True
        )
        self.twist_controller_event_in = rospy.Publisher(
            '~twist_controller_event_in', std_msgs.msg.String, latch=True
        )
        self.twist_limiter_event_in = rospy.Publisher(
            '~twist_limiter_event_in', std_msgs.msg.String, latch=True
        )
        self.twist_synchronizer_event_in = rospy.Publisher(
            '~twist_synchronizer_event_in', std_msgs.msg.String, latch=True
        )
        self.base_twist = rospy.Publisher('~twist', geometry_msgs.msg.Twist)

        # subscribers
        rospy.Subscriber("~event_in", std_msgs.msg.String, self.event_in_cb)
        rospy.Subscriber("~pose_monitor_feedback", mcr_monitoring_msgs.msgs.ComponentWisePoseErrorMonitorFeedback, self.pose_monitor_feedback_cb)
    ...
    def pose_monitor_feedback_cb(self, msg):
        ...
        """
        self.pose_monitor_feedback = msg.data
    ...
    def running_state(self):
        ...
        elif self.pose_monitor_feedback.is_linear_x_within_tolerance and 
